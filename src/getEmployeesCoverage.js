...
function getEmployeesCoverage(dadosEmployee) {
  if (dadosEmployee === undefined) return employees.map(getEmployeesCoverage);
  // recursividade: employees esta sendo mapeado e cada employee esta sendo passado a funcao.
